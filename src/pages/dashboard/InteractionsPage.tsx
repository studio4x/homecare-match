...
const InteractionsPage = () => {
  ...
  const fetchInteractions = async (userId: string, userRole: string, silent = false) => {
    ...
    try {
      const profileFields = 'id, full_name, avatar_url, specialty, role, phone, bio, city, state, neighborhood, ans_registration, patient_name, patient_age, patient_medical_conditions, patient_specialties, patient_mobility_level, patient_cognitive_state, patient_special_equipment, patient_communication_skills, availability';
