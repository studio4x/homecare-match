-- Clarifies recurring affiliate commission behavior by billing cadence.
-- Monthly plans: commission is generated on each valid monthly charge.
-- Yearly plans: commission is generated on initial contract payment and every valid renewal.
