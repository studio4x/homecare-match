...
const PwaSettingsPage = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Screenshots do Manifest</CardTitle>
          <CardDescription>
            Vertical e permitido e recomendado para mobile. Exemplo: 1080x2400 (narrow/retrato) ou 1920x1080 (wide/paisagem).
          </CardDescription>
        </CardHeader>
        <Collapsible open={screenshotsOpen} onOpenChange={setScreenshotsOpen}>
          <CollapsibleTrigger asChild>
            <Button variant="ghost" className="w-full justify-between px-6 py-4 text-base font-semibold">
              <span>{screenshotsOpen ? "Recolher" : "Expandir"} Screenshots ({formData.pwa_screenshots_json.length})</span>
          ...
          <CollapsibleContent className="px-6 pb-6 space-y-3">
            ...
            <Button type="button" variant="outline" className="w-full gap-2" onClick={addScreenshot}>
              <Plus className="h-4 w-4" /> Adicionar Screenshot
            </Button>
          </CollapsibleContent>
        </Collapsible>
      </Card>
