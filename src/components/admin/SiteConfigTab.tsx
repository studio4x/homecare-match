  ...
  useEffect(() => {
    if (config) {
      setFormData({
        ...
        payment_provider: config.payment_provider || "asaas",
        ...
        <CardContent className="space-y-6">
          <div className="grid gap-6 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => setFormData({ ...formData, asaas_environment: v })}
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="production">Producao (Real)</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
              <Label>URL base de checkout (opcional)</Label>
              <Input
                placeholder="https://sandbox.asaas.com"
                value={formData.asaas_checkout_base_url}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                min={1}
                max={12}
                value={formData.asaas_default_installment_max}
                onChange={(e) =>
                  setFormData({ ...formData, asaas_default_installment_max: parseInt(e.target.value || "1", 10) || 1 })
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                type="number"
                min={5}
                value={formData.asaas_checkout_expiration_minutes}
                onChange={(e) =>
                  setFormData({ ...formData, asaas_checkout_expiration_minutes: parseInt(e.target.value || "60", 10) || 60 })
                }
              />
            </div>
          </div>
          ...
          <div className="bg-secondary/20 p-4 rounded-lg border border-dashed">
            <p className="text-xs text-muted-foreground leading-relaxed">
              <strong>Lembrete:</strong> Configure as chaves no Supabase Secrets:
              <strong> ASAAS_API_KEY_SANDBOX</strong>, <strong>ASAAS_API_KEY_PRODUCTION</strong> e (opcional)
              <strong> ASAAS_WEBHOOK_TOKEN</strong>.
            </p>
          </div>
        </CardContent>
      </Card>
