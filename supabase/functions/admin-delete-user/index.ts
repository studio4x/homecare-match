...
const cleanupCandidates: Array<{ table: string; columns: string[] }> = [
  ...
  { table: "affiliate_partners", columns: ["user_id", "created_by"] },
  { table: "affiliate_attributions", columns: ["referred_user_id"] },
  { table: "affiliate_commission_ledger", columns: ["referred_user_id"] },
  { table: "affiliate_payout_batches", columns: ["approved_by", "paid_by"] },
